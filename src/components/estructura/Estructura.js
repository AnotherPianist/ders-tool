...
import { Toolbar, AppBar, IconButton, Drawer, Divider, List, ListItem, ListItemIcon, ListItemText, Typography, TextField, Button, Menu, MenuItem } from '@material-ui/core';
      ...
      <>
        ...
        <Drawer classes={{ paper: classes.drawerPaper }} anchor="left" open={this.state.isDrawerOpen} onClose={this.toggleDrawer}>
          ...
          <List>
            ...
            <ListItem button className={classes.whiteIcons} onClick={this.toggleDrawer} component={Link} to="/AnalisisRepago">
